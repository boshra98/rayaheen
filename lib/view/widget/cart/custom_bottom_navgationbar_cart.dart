...
class BottomNavgationBarCart extends GetView<CartController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CartController>(
      builder: (controller) {
        final discountAmount = controller.discountcoupon ?? 0;
        final totalBeforeDiscount = controller.priceorders;
        final totalAfterDiscount = controller.getTotalPrice();
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: 20),
                        child: Text("$discountAmount درهم", style: TextStyle(fontSize: 16)),
                      ),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: 20),
                        child: Text(
                          "${totalAfterDiscount.toStringAsFixed(1)} درهم",
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            wordSpacing: 4,
