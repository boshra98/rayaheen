          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                  ...
                  prefixIcon: Padding(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        value: selectedCountryCode, // Use selectedCountryCode here
                        ...
                        onChanged: (newCode) {
                          setState(() {
                            selectedCountryCode = newCode!; // Update selected code
                          });
                          controller.phone.clear(); // Clear phone input if needed
                        },
                      ),
                    ),
                  ),
                ...
                validator: (val) {
                  return validInput(val!, 8, 10, "phone", countryCode: selectedCountryCode);
                },
              ),
